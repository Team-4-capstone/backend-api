...
INSERT INTO description(id, size, color, quantity, secondary_color)
VALUES (1, 'lg', 'gray', '1', 'none'),
       (2, 'sm', 'green', '3', 'none'),
       (3, 'md', 'gray', '1', 'none'),
       (4, 'md', 'green', '1', 'none'),
       (5, 'sm', 'green', '1', 'none'),
